...
// Schema completo con validación condicional
...
interface MetodoPagoEditFormProps {
  metodoPago: MetodoPago;
}

export function MetodoPagoEditForm({ metodoPago }: MetodoPagoEditFormProps) {
  const router = useRouter();
  const { updateMetodoPago } = useMetodosPagoStore();
  const [activeTab, setActiveTab] = useState('basica');
  const [paisSearch, setPaisSearch] = useState('');
  const [isBasicaTabComplete, setIsBasicaTabComplete] = useState(true);
  ...
  const {
    ...
    defaultValues: {
      ...
      asociadoA: metodoPago.asociadoA || (!metodoPago.tipoCuenta ? 'servicio' : 'usuario') as any,
  ...
  const hasChanges = useMemo(() => {
    ...
    return false;
  }, [nombreValue, asociadoAValue, paisValue, monedaValue, aliasValue, titularValue, tipoCuentaValue, identificadorValue, emailValue, contrasenaValue, numeroTarjetaValue, fechaExpiracionValue, notasValue, metodoPago]);
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
        ...
        <TabsContent value="basica" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              {errors.asociadoA && (
                <p className="text-sm text-red-500">{errors.asociadoA.message as string}</p>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              {errors.pais && (
                <p className="text-sm text-red-500">{errors.pais.message as string}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {errors.moneda && (
                <p className="text-sm text-red-500">{errors.moneda.message as string}</p>
              )}
            </div>
          </div>
        ...
        <TabsContent value="adicional" className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            />
            {errors.titular && (
              <p className="text-sm text-red-500">{errors.titular.message as string}</p>
            )}
          </div>
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  {errors.tipoCuenta && (
                    <p className="text-sm text-red-500">{errors.tipoCuenta.message as string}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {errors.identificador && (
                    <p className="text-sm text-red-500">{errors.identificador.message as string}</p>
                  )}
                </div>
              </div>
            </>
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  {errors.contrasena && (
                    <p className="text-sm text-red-500">{errors.contrasena.message as string}</p>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  {errors.numeroTarjeta && (
                    <p className="text-sm text-red-500">{errors.numeroTarjeta.message as string}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {errors.fechaExpiracion && (
                    <p className="text-sm text-red-500">{errors.fechaExpiracion.message as string}</p>
                  )}
                </div>
              </div>
            </>
