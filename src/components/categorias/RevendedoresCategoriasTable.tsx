...
export function RevendedoresCategoriasTable({ categorias, onEdit, title = 'Categorías de Revendedores' }: RevendedoresCategoriasTableProps) {
  ...
  const filteredCategorias = useMemo(() => {
    return categoriasRevendedores.filter((categoria) => {
  ...
  }, [categoriasRevendedores, searchQuery, estadoFilter]);
